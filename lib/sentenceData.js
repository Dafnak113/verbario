...
export const SENTENCE_INFO = {
  hablar: { baseEn: "speak", pres3sEn: "speaks", pastEn: "spoke",
    complementEs: "con su jefe sobre el nuevo proyecto", complementEn: "with their boss about the new project",
    glossary: { jefe: "boss", nuevo: "new", proyecto: "project", sobre: "about" } },
  ...
  estar: { baseEn: "be", pres3sEn: "is", pastEn: "was",
    complementEs: "muy cansado después del viaje", complementEn: "very tired after the trip",
    glossary: { cansado: "tired", viaje: "trip" } },
  ser: { baseEn: "be", pres3sEn: "is", pastEn: "was",
    complementEs: "la persona responsable del equipo", complementEn: "the person responsible for the team",
    glossary: { persona: "person", responsable: "responsible", equipo: "team" } },
  ...
  pedir: { baseEn: "ask for", pres3sEn: "asks for", pastEn: "asked for",
    complementEs: "ayuda cuando la necesita", complementEn: "help when needed",
    glossary: { ayuda: "help", necesita: "needs" } },
  ...
  dar: { baseEn: "give", pres3sEn: "gives", pastEn: "gave",
    complementEs: "un buen consejo a sus amigos", complementEn: "good advice to their friends",
    glossary: { consejo: "advice", amigos: "friends", buen: "good" } },
  ...
  sentir: { baseEn: "feel", pres3sEn: "feels", pastEn: "felt",
    complementEs: "nervioso antes del examen", complementEn: "nervous before the exam",
    glossary: { nervioso: "nervous", examen: "exam" } },
  ...
  leer: { baseEn: "read", pres3sEn: "reads", pastEn: "read",
    complementEs: "el periódico mientras desayuna", complementEn: "the newspaper while having breakfast",
    glossary: { periódico: "newspaper", desayuna: "has breakfast" } },
